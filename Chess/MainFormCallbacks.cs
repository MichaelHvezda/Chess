...
namespace Chess
{
    public partial class MainForm : Form, UIBoard
    {
        ...
        private void NewGame(object sender, EventArgs e)
        {
            ...
            else if (button.Text.StartsWith("New Czech Player vs Player Game"))
            {
                NewGameCzech(2);
            }
            else if (button.Text.StartsWith("New Czech AI vs Player Game"))
            {
                NewGameCzech(1);
            }
            else if (button.Text.StartsWith("New Czech AI vs AI Game"))
            {
                NewGameCzech(0);
            }
        ...
        private void InsertPawns(object sender, EventArgs e)
        {
            InsertPawns();
        }
